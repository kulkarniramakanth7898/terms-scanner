    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans flex flex-col justify-between">
      ...
      <main className="mb-auto py-8">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center space-y-3 mb-6">
          <div className="inline-flex items-center space-x-2 px-3.5 py-1 bg-amber-50 border border-amber-200 rounded-full text-xs font-bold text-amber-800 shadow-sm">
